...
export default function Create({ auth, task, projects, users }: CreateProps) {
            ...
            >
              ...
              <div>
                ...
                <SelectInput
                  ...
                  onChange={(e: any) => setData("project_id", e.target.value)}
                >
              ...
              <div className="mt-4">
                ...
                <SelectInput
                  ...
                  className="mt-1 block w-full"
                  onChange={(e: any) => setData("assigned_user_id", e.target.value)}
                >
