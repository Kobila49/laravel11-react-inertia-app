...
export default function Index({auth, projects, queryParams = {}, success}: IndexProps) {
    ...
    const sortChanged = (name: keyof IndexProps["queryParams"]) => {
    ...
    const deleteProject = (project: IndexProps["projects"]["data"][0]) => {
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    {projects.data.map((project) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-3 py-2">
                                                <img src={project.image_path} style={{width: 60}} alt="Image failed to load"/>
                                            </td>
                          ...
                          >
                            {PROJECT_STATUS_TEXT_MAP[project.status]}
                                            ...
                                            <td className="px-3 py-2 text-nowrap">
                                                {/* Check if the user is an admin before showing the buttons */}
                                                {auth.user.role === "ADMIN" && (
                                                    <>
                                                        <Link
